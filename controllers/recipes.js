...
export const postCreateRecipeData = async (req, res) => {
  ...
  try {
    let newRecipeInDB = await db.one(
      "INSERT INTO recipes VALUES(${id}, ${nameRecipe}, ${mealType}, ${mealOrigin}, ${ingredients1}, ${ingredients2}, ${ingredients3}, ${ingredients4}, ${ingredients5}, ${ingredients6}, ${ingredients7}, ${ingredients8}, ${ingredients9}, ${ingredients10}, ${ingredients11}, ${ingredients12}, ${ingredients13}, ${ingredients14}, ${ingredients15}, ${ingredients16}, ${ingredients17}, ${ingredients18}, ${ingredients19}, ${ingredients20}, ${measurement1}, ${measurement2}, ${measurement3}, ${measurement4}, ${measurement5}, ${measurement6}, ${measurement7}, ${measurement8}, ${measurement9}, ${measurement10}, ${measurement11}, ${measurement12}, ${measurement13}, ${measurement14}, ${measurement15}, ${measurement16}, ${measurement17}, ${measurement18}, ${measurement19}, ${measurement20}, ${instruction}, ${url}, ${userid}) RETURNING *",
